<template>
  <div class="max-w-7xl mx-auto flex flex-col relative min-h-screen">
    <div class="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
      ...
      <div class="absolute bottom-[20%] left-[30%] w-[350px] h-[350px] bg-primary/10 rounded-full blur-[130px] animate-blob animation-delay-4000"></div>
    </div>
  ...
  <footer class="block md:hidden fixed bottom-0 left-0 right-0 rounded-t-3xl border border-[#383838] bg-[#121212] bg-opacity-80 backdrop-blur-md backdrop-opacity-90 z-50">
  ...
  <div class="fixed bottom-0 left-0 hidden md:flex flex-col items-center gap-6 px-10 after:content-[''] after:w-[1px] after:h-24 after:bg-slate-500 z-50">
    <a href="https://www.linkedin.com/in/djul-fikri-ferdiansyah-ba1a82368" target="_blank" class="text-slate-400 hover:text-primary hover:-translate-y-1 transition-all duration-300">
    ...
    <a href="https://instagram.com/mamang.fikriii" target="_blank" class="text-slate-400 hover:text-primary hover:-translate-y-1 transition-all duration-300">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
    </a>
    <a href="https://www.tiktok.com/@djulfikrii" target="_blank" class="text-slate-400 hover:text-primary hover:-translate-y-1 transition-all duration-300">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-tiktok"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg>
    </a>
  </div>
</template>
