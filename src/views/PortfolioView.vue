...
export default {
  mounted() {
    document.title = 'Portfolio | Djul Fikri Ferdiansyah';
  },
  data() {
    return {
      activeTab: 1,
      items: [
        {
          ...
          imageUrl: 'absensi',
          status: 'A mobile application for student attendance tracking using Flutter.',
          tech: 'Flutter, Dart, PostgreSQL',
          github: 'https://github.com/Mystery223/Absensi-mahasiswa',
          demo: 'null'
        },
        {
          id: 2,
          ...
          imageUrl: 'finance',
          status: 'A web-based application to track personal finances, income, and expenses.',
          tech: 'Python, Flask, HTML5, Vanilla CSS, Chart.js, Jinja2', 
          github: 'https://github.com/Mystery223/Personal-Finance-Tracker',
          demo: 'null'
        },
        {
          id: 3,
          ...
          imageUrl: 'company',
          status: 'A professional corporate website for representing brand identity and services.',
          tech: 'Next.js, React, TailwindCSS, PostgreSQL, Prisma ORM', 
          github: 'https://github.com/Mystery223/Company-Profile',
          demo: 'null'
        }
      ]
    };
...
<template>
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-slate-50 mx-3">
        ...
        <div>
          <div class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 fade-zoom-in">
            <div v-for="item in items" :key="item.id">
              <div
                class="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-slate-50 md:gap-3 px-5 py-5 lg:px-5 ">
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-primary">
                    {{ item.tech }}
                  </div>
